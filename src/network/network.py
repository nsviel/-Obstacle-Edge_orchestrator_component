...
class Network(daemon.Daemon):
    ...
    def update_perf_from_ground(self):
        if(param_edge.state_edge["interface"]["capture"]["http_connected"] == True):
            ...
            param_edge.state_network["ground_to_edge"]["throughput"]["value"] = 0
            param_edge.state_network["ground_to_edge"]["throughput"]["min"] = 0
            param_edge.state_network["ground_to_edge"]["throughput"]["max"] = 0
            param_edge.state_network["ground_to_edge"]["throughput"]["mean"] = 0

            param_edge.state_network["ground_to_edge"]["reliability"]["value"] = 0
            param_edge.state_network["ground_to_edge"]["reliability"]["min"] = 0
            param_edge.state_network["ground_to_edge"]["reliability"]["max"] = 0
            param_edge.state_network["ground_to_edge"]["reliability"]["mean"] = 0

            param_edge.state_network["ground_to_edge"]["interruption"]["value"] = 0
            param_edge.state_network["ground_to_edge"]["interruption"]["min"] = 0
            param_edge.state_network["ground_to_edge"]["interruption"]["max"] = 0
            param_edge.state_network["ground_to_edge"]["interruption"]["mean"] = 0

            param_edge.state_network["ground_to_edge"]["latency"]["value"] = 0
