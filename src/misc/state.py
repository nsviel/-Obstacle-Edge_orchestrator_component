...
def load_json_file():
    param_edge.state_edge = parser_json.load_state(param_edge.path_state_edge)
...
def init_state_capture():
    ...
    param_edge.state_edge["edge_next"]["sock_connected"] = False
    param_edge.state_edge["train_operator"]["broker_connected"] = False
...
def load_config_file():
    ...
    param_edge.state_edge["train_operator"]["broker_ip"] = config["train_operator"]["broker_ip"]
    param_edge.state_edge["train_operator"]["broker_port"] = config["train_operator"]["broker_port"]
    param_edge.state_edge["train_operator"]["mqtt_client"] = config["train_operator"]["mqtt_client"]
    param_edge.state_edge["train_operator"]["mqtt_topic"] = config["train_operator"]["mqtt_topic"]
    ...
    param_edge.state_edge["edge_next"]["ip"] = config["edge_next"]["ip"]
